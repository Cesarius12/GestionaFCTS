function inicializarAdmin() {
    ...
    //llamamos a la funcion que gestiona todos los botones del admin
    configurarBotones();
}
...
async function cargarProfesores() {
    try {
        ...
        userList.innerHTML = '';
        // Recorremos la lista de profesores y creamos un div por cada uno con sus datos relevantes a mostrar
        users.forEach(user => {
...
//si queremos editar nos lleva a editarProfesor.html
